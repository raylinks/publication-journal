    ...
    <div class="page-header">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h2 class="font-weight-semibold">Update Publications</h2>
            </div>
        </div>
    </div>
@stop
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h6 class="card-title">Edit Publication</h6>
                </div>

                <div class="card-body">
                    <form action="{{route('show.update', $publication->id)}}" method="POST"  enctype="multipart/form-data" >
                        @csrf
                        <div class="form-group">
                            <label>Publication title:</label>
                            <input type="text" required value="{{$publication->title}}"  class="form-control" name="title"
                                   placeholder="Enter title">
                        </div>
                        <div class="form-group">
                            <label>Author:</label>
                            <input type="text" class="form-control" value="{{$publication->author}}"    name="author" placeholder="Enter author">
                        </div>
                        <div class="form-group">
                            <label>Publication PDF:</label>
                            <input type="file" class="form-control"  value="{{$publication->image}}"   name="image"  id="image" >
                        </div>
                        <div class="form-group ">
                            <label class="d-block">Publication Year</label>
                            <select class="form-control " style="opacity:1 !important;" value="{{$publication->year}}"  name="year" data-fouc>
